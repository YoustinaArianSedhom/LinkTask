      ...
      >
        <div slot="header" class="mb-4">
          <div class="vx-row no-gutter">
            <!-- Current Month -->
            <div
              class="vx-col sm:w-1/3 w-full sm:my-0 flex sm:justify-center justify-center order-last"
            >
              <div class="flex items-center">
                <span class="mx-3 text-lg font-medium whitespace-no-wrap">{{
                  showDate | formatDate("YYYY-MM-DD")
                }}</span>
              </div>
            </div>

            <div class="vx-col sm:w-1/3 w-full mb-2 flex justify-start	">
